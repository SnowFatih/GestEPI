  ...
  return {
    ...
    >(
      ...
      if (typeof accessor === "function") {
        return {
          accessorFn: accessor as AccessorFn<TData, TValue>,
          ...column,
        } as ColumnDef<TData, TValue>;
      } else {
        return { accessorKey: accessor as keyof TData, ...column } as ColumnDef<
          TData,
          TValue
        >;
      }
    ...
    display(
      id: string,
      props: Omit<DisplayColumnDef<TData>, "id">
    ): DisplayColumnDef<TData> {
      return { id, ...props };
    },
    group(
      id: string,
      props: Omit<GroupColumnDef<TData>, "id">
